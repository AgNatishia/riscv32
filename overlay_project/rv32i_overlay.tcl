...
# module references:
# BD_neorv32_cpu_alu, BD_neorv32_cpu_control, BD_neorv32_cpu_bus, BD_neorv32_cpu_regfile, BD_neorv32_busswitch, BD_neorv32_wishbone, BD_wishbon_axi4lite_bridge
...
proc create_root_design { parentCell } {
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets cpu_BRAM_controller_BRAM_PORTA]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets neo_smartconnect_M00_AXI]
  ...
  connect_bd_net -net BD_neorv32_busswitch_0_p_bus_addr_o [get_bd_pins interface_bus_switch/p_bus_addr_o] [get_bd_pins interface_bus_to_wishbone/addr_i]
  ...
  connect_bd_net -net BD_neorv32_busswitch_0_p_bus_re_o [get_bd_pins interface_bus_switch/p_bus_re_o] [get_bd_pins interface_bus_to_wishbone/rden_i]
  ...
  connect_bd_net -net BD_neorv32_busswitch_0_p_bus_we_o [get_bd_pins interface_bus_switch/p_bus_we_o] [get_bd_pins interface_bus_to_wishbone/wren_i]
  ...
  connect_bd_net -net BD_neorv32_wishbone_0_ack_o [get_bd_pins interface_bus_switch/p_bus_ack_i] [get_bd_pins interface_bus_to_wishbone/ack_o]
  ...
  connect_bd_net -net BD_neorv32_wishbone_0_err_o [get_bd_pins interface_bus_switch/p_bus_err_i] [get_bd_pins interface_bus_to_wishbone/err_o]
  ...
  connect_bd_net -net Net [get_bd_pins cpu_alu/rstn_i] [get_bd_pins cpu_control_unit/rstn_i] [get_bd_pins cpu_external_bus_control/rstn_i] [get_bd_pins pynq_GPIO_neo_reset_slice/Dout]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets neorv32_cpu_control_fetch_pc_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED_controller/s_axi_aclk] [get_bd_pins button_controller/s_axi_aclk] [get_bd_pins cpu_BRAM_controller/s_axi_aclk] [get_bd_pins cpu_alu/clk_i] [get_bd_pins cpu_control_unit/clk_i] [get_bd_pins cpu_external_bus_control/clk_i] [get_bd_pins cpu_regfile/clk_i] [get_bd_pins interface_bus_switch/clk_i] [get_bd_pins interface_bus_to_wishbone/clk_i] [get_bd_pins interface_wishbone_to_axi/m_axi_aclk] [get_bd_pins neo_smartconnect/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pynq_BRAM_controller/s_axi_aclk] [get_bd_pins pynq_smartconnect/aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LED_controller/s_axi_aresetn] [get_bd_pins button_controller/s_axi_aresetn] [get_bd_pins cpu_BRAM_controller/s_axi_aresetn] [get_bd_pins interface_bus_switch/rstn_i] [get_bd_pins interface_bus_to_wishbone/rstn_i] [get_bd_pins interface_wishbone_to_axi/m_axi_aresetn] [get_bd_pins pynq_BRAM_controller/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins cpu_control_unit/mext_irq_i] [get_bd_pins cpu_control_unit/msw_irq_i] [get_bd_pins cpu_control_unit/mtime_irq_i] [get_bd_pins pull_down_1_bit/dout]
